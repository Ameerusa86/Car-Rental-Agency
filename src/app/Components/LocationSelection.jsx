...
// Locations Data
const Locations = [
  "Main St 123, United States",
  "Business Center, United States",
  "Park St, United Kingdom",
];
    ...
    <Menu as={"div"} className="w-full h-full flex xl:flex-row">
      <div className="relative flex-1">
        ...
        <Menu.Button className="dropdown-btn w-full h-full flex flex-col justify-center items-center xl:items-start xl:pl-8">
          <div className="w-ful h-16 xl:h-full flex justify-center xl:justify-start xl:border-r xl:border-black/10">
